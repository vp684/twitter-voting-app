...
class TwitterLogin extends Component {
    ...
    openPopup() {
      ...
      return window.open(
        "",
        "",
        "toolbar=no, location=yes, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, width=" +
          w +
          ", height=" +
          h +
          ", top=" +
    ...
    polling(popup) {       
      const polling = setInterval(() => {
        ...
        try {
          ...
          if (!window.location.hostname.includes("api.twitter.com") && window.location.hostname === "") {
